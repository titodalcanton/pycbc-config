...
WORKFLOW_NAME=o1-c02-clean-analysis-${n}-${GITHUB_TAG}
OUTPUT_PATH=${WEB_PATH}/${WORKFLOW_NAME}
WORKFLOW_TITLE="'O1 Analysis ${n} with Cleaned C02 Data'"
...
--config-files \
  ...
  ${CONFIG_INJ_URL}/nrinjections_o1.ini \
...
pycbc_submit_dax \
  ...
  --cache-file /home/juancalderonbustillo/Atlas/cbc/O1/reuse_caches/local_cit_reused_files_analysis-$n.map \
